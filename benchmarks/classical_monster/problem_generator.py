"""Generator for classical Monster problems. See monster.pddl for domain description."""

# code from Sam Toyer: see
# https://github.com/qxcv/asnets/blob/master/problems/mine/monster/generator.py
...
def format_problem(n, name):
    ...
    # prelude
    rv = ['(define (problem %s)' % name, '  (:domain classical-monster)']
